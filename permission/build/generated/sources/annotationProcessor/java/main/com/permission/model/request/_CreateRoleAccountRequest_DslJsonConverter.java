...
public class _CreateRoleAccountRequest_DslJsonConverter implements com.dslplatform.json.Configuration {
	private static final java.nio.charset.Charset utf8 = java.nio.charset.Charset.forName("UTF-8");
	@Override
	public void configure(com.dslplatform.json.DslJson __dsljson) {
		ObjectFormatConverter objectConverter = new ObjectFormatConverter(__dsljson);
		__dsljson.registerBinder(com.permission.model.request.CreateRoleAccountRequest.class, objectConverter);
		__dsljson.registerReader(com.permission.model.request.CreateRoleAccountRequest.class, objectConverter);
		__dsljson.registerWriter(com.permission.model.request.CreateRoleAccountRequest.class, objectConverter);
	}
	public final static class ObjectFormatConverter implements com.dslplatform.json.runtime.FormatConverter<com.permission.model.request.CreateRoleAccountRequest>, com.dslplatform.json.JsonReader.BindObject<com.permission.model.request.CreateRoleAccountRequest> {
		...
		public com.permission.model.request.CreateRoleAccountRequest read(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			if (reader.wasNull()) return null;
			return bind(reader, new com.permission.model.request.CreateRoleAccountRequest());
		}
		...
		public final void write(final com.dslplatform.json.JsonWriter writer, final com.permission.model.request.CreateRoleAccountRequest instance) {
		...
		public void writeContentFull(final com.dslplatform.json.JsonWriter writer, final com.permission.model.request.CreateRoleAccountRequest instance) {
		...
		public boolean writeContentMinimal(final com.dslplatform.json.JsonWriter writer, final com.permission.model.request.CreateRoleAccountRequest instance) {
		...
		public com.permission.model.request.CreateRoleAccountRequest bind(final com.dslplatform.json.JsonReader reader, final com.permission.model.request.CreateRoleAccountRequest instance) throws java.io.IOException {
			if (reader.last() != '{') throw reader.newParseError("Expecting '{' for object start");
			reader.getNextToken();
			bindContent(reader, instance);
			return instance;
		}
		public com.permission.model.request.CreateRoleAccountRequest readContent(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			com.permission.model.request.CreateRoleAccountRequest instance = new com.permission.model.request.CreateRoleAccountRequest();
 			bindContent(reader, instance);
			return instance;
		}
		public void bindContent(final com.dslplatform.json.JsonReader reader, final com.permission.model.request.CreateRoleAccountRequest instance) throws java.io.IOException {
		...
		private void bindSlow(final com.dslplatform.json.JsonReader reader, final com.permission.model.request.CreateRoleAccountRequest instance, int index) throws java.io.IOException {
