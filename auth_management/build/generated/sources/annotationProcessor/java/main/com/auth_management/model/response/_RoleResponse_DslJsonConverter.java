...
public class _RoleResponse_DslJsonConverter implements com.dslplatform.json.Configuration {
	...
	public void configure(com.dslplatform.json.DslJson __dsljson) {
		...
		__dsljson.registerBinder(com.auth_management.model.response.RoleResponse.class, objectConverter);
		__dsljson.registerReader(com.auth_management.model.response.RoleResponse.class, objectConverter);
		__dsljson.registerWriter(com.auth_management.model.response.RoleResponse.class, objectConverter);
	}
	public final static class ObjectFormatConverter implements com.dslplatform.json.runtime.FormatConverter<com.auth_management.model.response.RoleResponse>, com.dslplatform.json.JsonReader.BindObject<com.auth_management.model.response.RoleResponse> {
		...
		public com.auth_management.model.response.RoleResponse read(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			if (reader.wasNull()) return null;
			return bind(reader, new com.auth_management.model.response.RoleResponse());
		}
		...
		public final void write(final com.dslplatform.json.JsonWriter writer, final com.auth_management.model.response.RoleResponse instance) {
		...
		public void writeContentFull(final com.dslplatform.json.JsonWriter writer, final com.auth_management.model.response.RoleResponse instance) {
		...
		public boolean writeContentMinimal(final com.dslplatform.json.JsonWriter writer, final com.auth_management.model.response.RoleResponse instance) {
		...
		public com.auth_management.model.response.RoleResponse bind(final com.dslplatform.json.JsonReader reader, final com.auth_management.model.response.RoleResponse instance) throws java.io.IOException {
			if (reader.last() != '{') throw reader.newParseError("Expecting '{' for object start");
			reader.getNextToken();
			bindContent(reader, instance);
			return instance;
		}
		public com.auth_management.model.response.RoleResponse readContent(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			com.auth_management.model.response.RoleResponse instance = new com.auth_management.model.response.RoleResponse();
 			bindContent(reader, instance);
			return instance;
		}
		public void bindContent(final com.dslplatform.json.JsonReader reader, final com.auth_management.model.response.RoleResponse instance) throws java.io.IOException {
		...
		private void bindSlow(final com.dslplatform.json.JsonReader reader, final com.auth_management.model.response.RoleResponse instance, int index) throws java.io.IOException {
