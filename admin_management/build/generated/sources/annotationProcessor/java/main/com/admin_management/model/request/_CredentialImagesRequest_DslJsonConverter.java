...
public class _CredentialImagesRequest_DslJsonConverter implements com.dslplatform.json.Configuration {
	private static final java.nio.charset.Charset utf8 = java.nio.charset.Charset.forName("UTF-8");
	@Override
	public void configure(com.dslplatform.json.DslJson __dsljson) {
		ObjectFormatConverter objectConverter = new ObjectFormatConverter(__dsljson);
		__dsljson.registerBinder(com.admin_management.model.request.CredentialImagesRequest.class, objectConverter);
		__dsljson.registerReader(com.admin_management.model.request.CredentialImagesRequest.class, objectConverter);
		__dsljson.registerWriter(com.admin_management.model.request.CredentialImagesRequest.class, objectConverter);
	}
	public final static class ObjectFormatConverter implements com.dslplatform.json.runtime.FormatConverter<com.admin_management.model.request.CredentialImagesRequest>, com.dslplatform.json.JsonReader.BindObject<com.admin_management.model.request.CredentialImagesRequest> {
		...
		public com.admin_management.model.request.CredentialImagesRequest read(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			if (reader.wasNull()) return null;
			return bind(reader, new com.admin_management.model.request.CredentialImagesRequest());
		}
		...
		public final void write(final com.dslplatform.json.JsonWriter writer, final com.admin_management.model.request.CredentialImagesRequest instance) {
		...
		public void writeContentFull(final com.dslplatform.json.JsonWriter writer, final com.admin_management.model.request.CredentialImagesRequest instance) {
		...
		public boolean writeContentMinimal(final com.dslplatform.json.JsonWriter writer, final com.admin_management.model.request.CredentialImagesRequest instance) {
		...
		public com.admin_management.model.request.CredentialImagesRequest bind(final com.dslplatform.json.JsonReader reader, final com.admin_management.model.request.CredentialImagesRequest instance) throws java.io.IOException {
			if (reader.last() != '{') throw reader.newParseError("Expecting '{' for object start");
			reader.getNextToken();
			bindContent(reader, instance);
			return instance;
		}
		public com.admin_management.model.request.CredentialImagesRequest readContent(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			com.admin_management.model.request.CredentialImagesRequest instance = new com.admin_management.model.request.CredentialImagesRequest();
 			bindContent(reader, instance);
			return instance;
		}
		public void bindContent(final com.dslplatform.json.JsonReader reader, final com.admin_management.model.request.CredentialImagesRequest instance) throws java.io.IOException {
		...
		private void bindSlow(final com.dslplatform.json.JsonReader reader, final com.admin_management.model.request.CredentialImagesRequest instance, int index) throws java.io.IOException {
