...
public class _ManagerClaim_DslJsonConverter implements com.dslplatform.json.Configuration {
	private static final java.nio.charset.Charset utf8 = java.nio.charset.Charset.forName("UTF-8");
	@Override
	public void configure(com.dslplatform.json.DslJson __dsljson) {
		ObjectFormatConverter objectConverter = new ObjectFormatConverter(__dsljson);
		__dsljson.registerBinder(com.common.model.ManagerClaim.class, objectConverter);
		__dsljson.registerReader(com.common.model.ManagerClaim.class, objectConverter);
		__dsljson.registerWriter(com.common.model.ManagerClaim.class, objectConverter);
	}
	public final static class ObjectFormatConverter implements com.dslplatform.json.runtime.FormatConverter<com.common.model.ManagerClaim>, com.dslplatform.json.JsonReader.BindObject<com.common.model.ManagerClaim> {
		...
		public com.common.model.ManagerClaim read(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			if (reader.wasNull()) return null;
			return bind(reader, new com.common.model.ManagerClaim());
		}
		...
		private static final byte[] quoted_bitSet = ",\"bit_set\":".getBytes(utf8);
		private static final byte[] name_bitSet = "bit_set".getBytes(utf8);
		...
		public final void write(final com.dslplatform.json.JsonWriter writer, final com.common.model.ManagerClaim instance) {
		...
		public void writeContentFull(final com.dslplatform.json.JsonWriter writer, final com.common.model.ManagerClaim instance) {
		...
		public boolean writeContentMinimal(final com.dslplatform.json.JsonWriter writer, final com.common.model.ManagerClaim instance) {
		...
		public com.common.model.ManagerClaim bind(final com.dslplatform.json.JsonReader reader, final com.common.model.ManagerClaim instance) throws java.io.IOException {
			if (reader.last() != '{') throw reader.newParseError("Expecting '{' for object start");
			reader.getNextToken();
			bindContent(reader, instance);
			return instance;
		}
		public com.common.model.ManagerClaim readContent(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			com.common.model.ManagerClaim instance = new com.common.model.ManagerClaim();
 			bindContent(reader, instance);
			return instance;
		}
		public void bindContent(final com.dslplatform.json.JsonReader reader, final com.common.model.ManagerClaim instance) throws java.io.IOException {
			...
			if (reader.fillNameWeakHash() != 746 || !reader.wasLastName(name_bitSet)) { bindSlow(reader, instance, 1); return; }
			reader.getNextToken();
		...
		private void bindSlow(final com.dslplatform.json.JsonReader reader, final com.common.model.ManagerClaim instance, int index) throws java.io.IOException {
